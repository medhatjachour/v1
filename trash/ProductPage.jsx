  ...
  return (
    <>
      ...
      <div className="productViewSection">   
        ...
        >
            <Grid item lg={2} md={5} sm={5} xs={12} order={{ md: 2, xs: 2, sm: 2, lg: 1 }}>
            ...
            <Grid item lg={7} md={12} sm={12} xs={12} order={{ md: 1, xs: 1, sm: 1, lg: 2 }}>
            <>
                ...
                <svg class="circle-container" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 70 1000 810">
                    <defs>
                        ...
                        <image x="0%" y="0%" width="300" height="300" href="logo512"></image>
                        </pattern>
                    ...
                    <foreignObject  class="circle circle--main" width="50%" height="50%" x="50%" y="50%" >
                      <div>
                        sdasd
                      </div>
                    </foreignObject >
            ...
            <Grid item lg={3} md={7} sm={7} xs={12} order={{ md: 3, xs: 3, sm: 3, lg: 3 }}>
